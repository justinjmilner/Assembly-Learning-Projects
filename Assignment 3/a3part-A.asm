...
unset_char:							; Displays '-' char is button not pressed
	ldi temp, 0x2D

display_char:		
	ldi r18, 1						; Load the row for lcd_gotoxy
	ldi r19, 15						; Load the final column for lcd_gotoxy
	push r18						; Initialize stack frame with row/col vals
	push r19
	rcall lcd_gotoxy				; Initialize location to display char on lcd screen
	pop r19
	pop r18

	push temp						; Push temp onto the stack for sub routine call
	rcall lcd_putchar				; Call subroutine to display char
	pop temp
